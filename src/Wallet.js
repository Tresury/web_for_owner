...
import OrderForTokens from './OrderForTokens';
import OrderToTokens from './OrderToTokens';
...
const Wallet = () => {
    ...
    const eventContract = new ethers.Contract(contractAddress, simple_token_abi, eventProvider);
	const orderContract = new ethers.Contract(orderContractAddress, orders_abi, eventProvider);
...
*/
	...
	<div>
		...
		<OrderForTokens eventContract={eventContract}/>
		<OrderToTokens eventContract={orderContract} contract={contract}/>
